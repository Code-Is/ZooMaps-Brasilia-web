 ...
 * @version 1.0.0
 */
class RecintoForm extends Form implements InputFilterProviderInterface
{
    ...
    public function __construct(\Doctrine\Common\Persistence\ObjectManager $objectManager)
    {
        ...
        parent::__construct('recinto');
        
        $this->setHydrator(new DoctrineObject($objectManager))->setObject(new \Cadastro\Entity\Recinto());
            ...
            'nome' => array(
                ...
                'validators' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'object_repository' => $this->objectManager->getRepository('Cadastro\Entity\Recinto'),
                            'object_manager' => $this->objectManager,
                            'fields' => 'nome',
                            'messages' => array(
                                \DoctrineModule\Validator\UniqueObject::ERROR_OBJECT_NOT_UNIQUE => \Application\Common\Message::NOT_UNIQUE('um recinto', 'esse nome')
                            )                            
                        )
                    )
                )
