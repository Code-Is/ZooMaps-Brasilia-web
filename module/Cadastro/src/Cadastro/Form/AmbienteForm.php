 ...
 * @version 1.0.0
 */
class AmbienteForm extends Form implements InputFilterProviderInterface
{
    ...
    public function __construct(\Doctrine\Common\Persistence\ObjectManager $objectManager)
    {
        ...
        $this->setHydrator(new DoctrineObject($objectManager))->setObject(new \Cadastro\Entity\Ambiente());
            ...
            'nome' => array(
                ...
                'validators' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'object_repository' => $this->objectManager->getRepository('Cadastro\Entity\Ambiente'),
                            'object_manager' => $this->objectManager,
                            'fields' => 'nome',
                            'messages' => array(
                                \DoctrineModule\Validator\UniqueObject::ERROR_OBJECT_NOT_UNIQUE => \Application\Common\Message::NOT_UNIQUE('um ambiente', 'esse nome')
                            )                            
                        )
                    )
                )
