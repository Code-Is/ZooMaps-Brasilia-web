 ...
 * @version 1.0.0
 */
class AtividadeForm extends Form implements InputFilterProviderInterface
{
    ...
    public function __construct(\Doctrine\Common\Persistence\ObjectManager $objectManager)
    {
        ...
        $this->setHydrator(new DoctrineObject($objectManager))->setObject(new \Cadastro\Entity\Atividade());
            ...
            'nome' => array(
                ...
                'validators' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'object_repository' => $this->objectManager->getRepository('Cadastro\Entity\Atividade'),
                            'object_manager' => $this->objectManager,
                            'fields' => 'nome',
                            'messages' => array(
                                \DoctrineModule\Validator\UniqueObject::ERROR_OBJECT_NOT_UNIQUE => \Application\Common\Message::NOT_UNIQUE('uma atividade', 'esse nome')
                            )                            
                        )
                    )
                )
